...
_DEFAULTS: dict = {
    ...
    OPT_PRESENCE_STALE_MIN: DEFAULT_PRESENCE_STALE_MIN,
    ...
    OPT_HONOR_NATIVE: DEFAULT_HONOR_NATIVE,
    OPT_AUTO_RECOVER: DEFAULT_AUTO_RECOVER,
    OPT_QUIET_RECOVERY: DEFAULT_QUIET_RECOVERY,
    OPT_CATCHUP_ENABLED: DEFAULT_CATCHUP_ENABLED,
    OPT_CATCHUP_DAY: DEFAULT_CATCHUP_DAY,
    OPT_CATCHUP_TIME: DEFAULT_CATCHUP_TIME,
    OPT_OPPORTUNISTIC_CATCHUP: DEFAULT_OPPORTUNISTIC_CATCHUP,
    OPT_HOLIDAY_ENABLED: DEFAULT_HOLIDAY_ENABLED,
    OPT_HOLIDAY_AFTER_DAYS: DEFAULT_HOLIDAY_AFTER_DAYS,
    ...
    OPT_MANUAL_CLEAN_ENABLED: DEFAULT_MANUAL_CLEAN_ENABLED,
    OPT_MANUAL_CLEAN_STALE_DAYS: DEFAULT_MANUAL_CLEAN_STALE_DAYS,
    OPT_MANUAL_CLEAN_MIN_MISSES: DEFAULT_MANUAL_CLEAN_MIN_MISSES,
    OPT_MANUAL_CLEAN_NOTIFY: DEFAULT_MANUAL_CLEAN_NOTIFY,
    OPT_SHOW_UNREACHABLE: DEFAULT_SHOW_UNREACHABLE,
    OPT_PRERUN_ENABLED: DEFAULT_PRERUN_ENABLED,
    OPT_PRERUN_MODE: DEFAULT_PRERUN_MODE,
    OPT_PRERUN_TIME: DEFAULT_PRERUN_TIME,
    OPT_PRERUN_LEAD_MIN: DEFAULT_PRERUN_LEAD_MIN,
    ...
    OPT_CONSUMABLE_ALERT: DEFAULT_CONSUMABLE_ALERT,
    OPT_CONSUMABLE_THRESHOLD: DEFAULT_CONSUMABLE_THRESHOLD,
    OPT_EDGE_ENABLED: DEFAULT_EDGE_ENABLED,
    OPT_EDGE_EVERY_DAYS: DEFAULT_EDGE_EVERY_DAYS,
...
_VALIDATORS: dict = {
    ...
    OPT_HONOR_NATIVE: bool,
    OPT_AUTO_RECOVER: bool, OPT_QUIET_RECOVERY: bool,
    OPT_CATCHUP_ENABLED: bool, OPT_OPPORTUNISTIC_CATCHUP: bool,
    OPT_HOLIDAY_ENABLED: bool,
    OPT_HOLIDAY_AFTER_DAYS: vol.All(vol.Coerce(int), vol.Range(min=1, max=60)),
    OPT_STALE_NUDGE_ENABLED: bool,
    OPT_NOTIFY_STUCK: bool, OPT_NOTIFY_SKIPPED: bool, OPT_NOTIFY_WEEKLY: bool,
    OPT_CONSUMABLE_ALERT: bool,
    OPT_CONSUMABLE_THRESHOLD: vol.All(vol.Coerce(int), vol.Range(min=1, max=100)),
    OPT_EDGE_ENABLED: bool,
    OPT_EDGE_EVERY_DAYS: vol.All(vol.Coerce(int), vol.Range(min=0, max=60)),
    OPT_EDGE_TIME: _HHMM,
    ...
    OPT_SHOW_UNREACHABLE: bool,
    OPT_MANUAL_CLEAN_STALE_DAYS: vol.All(vol.Coerce(int), vol.Range(min=1, max=365)),
    OPT_MANUAL_CLEAN_MIN_MISSES: vol.All(vol.Coerce(int), vol.Range(min=1, max=50)),
    OPT_PRERUN_MODE: vol.In(("morning", "evening_before", "lead")),
    OPT_PRERUN_TIME: _HHMM,
    OPT_PRERUN_LEAD_MIN: vol.All(vol.Coerce(int), vol.Range(min=0, max=1440)),
    ...
    OPT_PRESENCE_STALE_MIN: vol.All(vol.Coerce(int), vol.Range(min=0, max=1440)),
